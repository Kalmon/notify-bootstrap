...
function notify(options) {
    ...
    switch (data_type) {
        ...
        case 'spinner-third':
            ...
            /*DEFAULT*/
        default:
            data_icon = `<i style="width:35px;height:35px" class="fas fa-${data_type}"></i>`;
    }
